...
import { deleteSavingById, getSavingById } from "@/helpers/auth";
...
const SavingDetailsPage = ({
	...
	const { categories: savingsCategory } = useCategories("Savings", token);
...
export async function getServerSideProps(
	...
	const allSavings = await getSavingById(
		parseInt(String(savingID)),
		session?.accessToken,
	);
